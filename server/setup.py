...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/launch', [
            ...
            'launch/opfor.launch.py',
            'launch/engagement.launch.py',
            'launch/world_state.launch.py',
            'launch/los.launch.py',
        ]),
    ...
    entry_points={
        'console_scripts': [
            ...
            'opfor_node = plato_pod.opfor_node:main',
            'engagement_node = plato_pod.engagement_node:main',
            'world_state_node = plato_pod.world_state_node:main',
            'los_python_node = plato_pod.los_python_node:main',
            'los_gazebo_node = plato_pod.los_gazebo_node:main',
